    ...
    <div className="relative flex flex-col justify-center items-center min-h-screen p-6 bg-black text-white overflow-hidden">
      ...
      <div className="relative z-10 backdrop-blur-md bg-opacity-50 p-6 rounded-lg">
        <div className=" flex gap-3 text-center justify-center items-center">
          <h1 className="text-center font-bold text-7xl mb-8">Bienvenidos</h1>
          <Welcome />

        </div>
        
        <div className="flex gap-8 text-center justify-center items-center w-full max-w-5xl">
          <div className="w-1/2">
            <img src={img1} className="w-full h-auto rounded-lg shadow-lg" alt="Elecciones" />
          </div>
          <div className="w-1/2 text-[25px] font-semibold leading-relaxed">
            <h2>
